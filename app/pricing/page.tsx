...
const features = ["一个激活码只绑定一个账号", "每个激活码可转换 5 次", "支持页面所列格式", "个人中心查看剩余次数"];
