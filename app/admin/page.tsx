...
const planNames: Record<string, string> = { trial: "历史体验码", monthly: "历史月卡", yearly: "历史年卡", lifetime: "主人权限", credits: "5 次转换" };
...
export default function AdminPage() {
  ...
  const updateUser = async (user: UserRow) => { if (!confirm(`确认给 ${user.email} 补充 5 次转换？`)) return; await callAdmin("update-user", { userId: user.id }); await load(); };
