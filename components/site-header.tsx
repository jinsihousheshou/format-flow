...
export default function SiteHeader() {
  ...
  const links = [{ label: "首页", href: "/" }, { label: "人工精修", href: "/#manual-services" }, { label: "视频下载", href: "/video-download/" }, { label: "音频下载", href: "/audio-download/" }, { label: "购买说明", href: "/pricing/" }, ...(session ? [{ label: "个人中心", href: "/account/" }] : []), ...(account.isAdmin ? [{ label: "管理后台", href: "/admin/" }] : [])];
  return <>
